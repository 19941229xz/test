...
public class EmailUtil {
	...
	public static void sendTest(String qq) {
		...
		props.put("mail.password", "orckqcramyrfdieg");
		...
		try {
			...
			// 设置邮件的内容体
			message.setContent("斗鱼直播地址：https://www.douyu.com/4920442", "text/html;charset=UTF-8");
	...
	public static void sendOneNomal(Map<String,Object> params) {// 给一个人
		...
		props.put("mail.smtp.host", "smtp.qq.com");
		props.put("mail.smtp.port", "587");
		props.put("mail.user", "972031129@qq.com");
		props.put("mail.password", "vifkhmiyglczbdgj");
		Authenticator authenticator = new Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				String userName = props.getProperty("mail.user");
				String password = props.getProperty("mail.password");
	 ...
	 * @param content
	 */
	public static void sendOneHtml(String address, String title, String content) {// 给一个人
																		// html邮件
		Properties props = new Properties();
		props.put("mail.smtp.auth", "true");
		props.put("mail.smtp.host", "smtp.qq.com");
